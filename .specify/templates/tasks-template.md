...
**Tests**: Per Constitution Principle II (Test-First Development), tests are MANDATORY. All test tasks MUST be written and FAIL before implementation begins. Red-Green-Refactor cycle is enforced.
...
- [ ] TXXX Performance optimization across all stories (verify Core Web Vitals)
- [ ] TXXX [P] Accessibility audit (WCAG AA compliance check)
- [ ] TXXX Security hardening (input validation, rate limiting)
- [ ] TXXX [P] TypeScript strict mode compliance verification
